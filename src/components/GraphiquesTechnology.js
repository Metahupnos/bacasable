...
function GraphiquesTechnology() {
  ...
  const stocks = [
    { symbol: 'LPTH', name: 'Latham Group', color: '#2196f3', units: 10, buyPrice: 0, buyDate: '2025-12-30', description: 'Piscines et solutions outdoor' },
    { symbol: 'AAOI', name: 'Applied Optoelectronics', color: '#ff5722', units: 10, buyPrice: 0, buyDate: '2025-12-30', description: 'Composants optiques data centers' },
    { symbol: 'ZETA', name: 'Zeta Global', color: '#4caf50', units: 10, buyPrice: 0, buyDate: '2025-12-30', description: 'Plateforme marketing/données' },
    { symbol: 'MU', name: 'Micron Technology', color: '#673ab7', units: 10, buyPrice: 0, buyDate: '2025-12-30', description: 'Mémoires DRAM/NAND - pilier IA' },
    { symbol: 'PATH', name: 'UiPath', color: '#ff9800', units: 10, buyPrice: 0, buyDate: '2025-12-30', description: 'Automatisation logicielle RPA' },
    { symbol: 'VELO', name: 'Velocity Financial', color: '#00bcd4', units: 10, buyPrice: 0, buyDate: '2025-12-30', description: 'Financement immobilier / crédit' }
  ];
  ...
  if (loading) {
    return (
      <div className="charts-container">
        <h1>Graphiques Portfolio Technology</h1>
  ...
  return (
    <div className="charts-container">
      <div className="nav-buttons">
        ...
        <button onClick={() => navigate('/technology')} className="nav-button">Portfolio</button>
      </div>
...
export default GraphiquesTechnology;
