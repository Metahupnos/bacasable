...
function GraphiquesMel() {
  ...
  const stocks = [
    { symbol: 'LLY', name: 'Eli Lilly and Co.', color: '#4caf50', units: 146 },
    { symbol: 'GOOGL', name: 'Alphabet Inc. (Class A)', color: '#2196f3', units: 135 },
    { symbol: 'IDXX', name: 'Idexx Laboratories', color: '#f44336', units: 42 }
  ];
