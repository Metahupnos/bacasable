...
function GraphiquesIndustrials() {
  ...
  const stocks = [
    { symbol: 'ZIM', name: 'ZIM Integrated Shipping', color: '#2196f3', units: 10, buyPrice: 0, buyDate: '2025-12-30', description: 'Transport maritime conteneurs' },
    { symbol: 'KRMN', name: 'Karman Space & Defense', color: '#4caf50', units: 10, buyPrice: 0, buyDate: '2025-12-30', description: 'Aérospatial et défense' },
    { symbol: 'SBLK', name: 'Star Bulk Carriers', color: '#ff9800', units: 10, buyPrice: 0, buyDate: '2025-12-30', description: 'Transport maritime vrac sec' },
    { symbol: 'LUNR', name: 'Intuitive Machines', color: '#9c27b0', units: 10, buyPrice: 0, buyDate: '2025-12-30', description: 'Missions lunaires / spatial' },
    { symbol: 'MAN', name: 'ManpowerGroup', color: '#00bcd4', units: 10, buyPrice: 0, buyDate: '2025-12-30', description: 'Travail intérimaire / recrutement' }
  ];
  ...
  if (loading) {
    return (
      <div className="charts-container">
        <h1>Graphiques Portfolio Industrials</h1>
  ...
  return (
    <div className="charts-container">
      <div className="nav-buttons">
        ...
        <button onClick={() => navigate('/industrials')} className="nav-button">Portfolio</button>
      </div>
...
export default GraphiquesIndustrials;
