...
function GraphiquesBasicMaterials() {
  ...
  const stocks = [
    { symbol: 'ERO', name: 'Ero Copper', color: '#ff5722', units: 10, buyPrice: 0, buyDate: '2025-12-30', description: 'Producteur cuivre Amérique latine' },
    { symbol: 'ALB', name: 'Albemarle', color: '#4caf50', units: 10, buyPrice: 0, buyDate: '2025-12-30', description: 'Leader mondial lithium' },
    { symbol: 'PAAS', name: 'Pan American Silver', color: '#c0c0c0', units: 10, buyPrice: 0, buyDate: '2025-12-30', description: 'Producteur argent et or' },
    { symbol: 'CDE', name: 'Coeur Mining', color: '#ffc107', units: 10, buyPrice: 0, buyDate: '2025-12-30', description: 'Métaux précieux' },
    { symbol: 'HYMC', name: 'Hycroft Mining', color: '#9c27b0', units: 2000, buyPrice: 27.73, buyDate: '2026-01-05', description: 'Or/argent spéculatif' }
  ];
  ...
  if (loading) {
    return (
      <div className="charts-container">
        <h1>Graphiques Portfolio Basic Materials</h1>
  ...
  return (
    <div className="charts-container">
      <div className="nav-buttons">
        ...
        <button onClick={() => navigate('/materials')} className="nav-button">Portfolio</button>
      </div>
...
export default GraphiquesBasicMaterials;
